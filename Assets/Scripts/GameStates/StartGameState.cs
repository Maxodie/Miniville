...
public class StartGameState : GameState {
    ...
    void LoadPlayersBoards() {
        ...
        for(int i=0; i<playerNb; i++) {
            ...
            if(i==0)
                gameData.players[i] = new Player(true, $"Player {i}", 80, 2, 1, initialDeck.ToList(), gameData.monuments, playerCanvasPrefab, game.uiData.playerFrames[i], game.uiData.uIPlayerFrameScriptableObject);
            else
